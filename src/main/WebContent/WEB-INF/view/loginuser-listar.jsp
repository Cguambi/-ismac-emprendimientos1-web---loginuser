...
<section class="py-5 px-5">
		<div class="container">
			...
			<div class="container" style="text-align: center;">
				<button class="btn btn-primary" onclick="window.location.href='/ismac-emprendimientos1-web/usuario/findOne?opcion=1'; return false;">
							...
							<tr>
								...
								<td>
									<div class="container-fluid btn-group" role="group" >
										<button class="btn btn-success" onclick="window.location.href='/ismac-emprendimientos1-web/usuario/findOne?id_user=${item.id}&opcion=1'; return false;">
											<i class="fa-solid fa-rotate-left">
											<!-- Actualizar -->
											</i>																			
										</button>
										<button class="btn btn-danger" onclick="window.location.href='/ismac-emprendimientos1-web/usuario/findOne?id_user=${item.id}&opcion=2'; return false;">
